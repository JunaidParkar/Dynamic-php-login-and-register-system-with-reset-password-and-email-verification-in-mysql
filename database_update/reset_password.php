...
// if (!empty($_GET['regid'])) {
    if (isset($_GET['res'])) {
        ...
        $confPass = $_GET['confirmPassword'];
        $id = $_GET['res'];
        if ($password == $confPass) {
            $hashed_new_pass = password_hash($password,PASSWORD_BCRYPT);
            $getUID = "SELECT * FROM `users` WHERE `registeration_id` = '$id'";
            $UID_query = mysqli_query($con, $getUID);
            if (mysqli_num_rows($UID_query) > 0) {
                $UID_fetch = mysqli_fetch_assoc($UID_query);
                $UID = $UID_fetch['uid'];
                $change_pass = "UPDATE `users` SET `password`='$hashed_new_pass' WHERE `uid` = '$UID'";
                mysqli_query($con, $change_pass);
                change_registration_Id($con, $id);
            }
...
<body>
    <form action="#" method="get" style="max-width:500px;margin:auto">
      <center>
      <img src="data:image/png;base64,">
        ...
        <div class="input-container"><i class="fa fa-key icon"></i>
            <input class="input-field" id="password-1" type="password" placeholder="Type your new password" name="password">
        </div>
        <!-- Length  -->
        <span id="pwd-length-1"></span>
        <!-- Second Input Text  -->
        <div class="input-container"><i class="fa fa-key icon"></i>
            <input class="input-field" id="password-2" type="password" placeholder="Re-type your new password" name="confirmPassword">
        </div>
        <!-- Length  -->
        <span id="pwd-length-2"></span>
        <!-- Validation Message - 1  -->
        <span id="message"></span>
        <button class="btn" id="formSubmit" name="res" value="<?php echo $regID = $_GET['regid'] ?>">Register</button>
    </form>
</body>
</html>